...
?>
<li itemprop="review" itemscope itemtype="http://schema.org/Review" <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>" style="list-style-type:none;">

	<div id="comment-<?php comment_ID(); ?>" class="comment_container">
		<div style="float:left">
		<?php echo get_avatar( $comment, apply_filters( 'woocommerce_review_gravatar_size', '60' ), '' ); ?>
		</div>
		<div class="comment-text" style="margin-left:7%;">
