...
<form method="post" class="lost_reset_password">
	...
	<?php if( 'lost_password' == $args['form'] ) : ?>
		...
		<p><?php echo apply_filters( 'woocommerce_lost_password_message', __( '<h2>Lost your password?</h2> Please enter your username or email address. You will receive a link to create a new password via email.', 'woocommerce' ) ); ?></p>
