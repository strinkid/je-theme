...
<?php
	...
	if ( $order->billing_phone ) {
		...
		echo '<tr><th><p><strong>'.__('Mobile Phone', 'woocommerce').':</strong></th><td> ' . $order->billing_mobile . '</p></td></tr>';
		echo '<tr><th><p><strong>'.__('Bank Name', 'woocommerce').':</strong></th><td> ' . $order->billing_payment_method_bank_name . '</p></td></tr>';
		echo '<tr><th><p><strong>'.__('Bank Account Name', 'woocommerce').':</strong></th><td> ' . $order->billing_payment_method_account_name . '</p></td></tr>';
